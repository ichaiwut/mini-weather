...
<template>
        ...
        <div class=" bg-white h-60 rounded-2xl mx-5 shadow px-3">
            <div class="flex items-center md:justify-between">
                <div>
                    <h2 class="text-2xl font-bold cursor-default mx-4 mt-5 md:mt-0">Weather Forecast</h2>
                </div>
                <div class="flex">
                     <div class="my-auto mx-5 w-[100px] md:w-[80px]">
            ...
            <div class="p-4 overflow-x-auto">
                <!-- Hourly Forecast -->
                <router-link :to="{ name: 'hourly', params: { city: weatherData.location.name } }" v-if="
                    isHourly &&
                    weatherData &&
                ...
                " class="flex gap-4">
                    ...
                    <div v-for="(hour, index) in weatherData.forecast.forecastday[0].hour" :key="index"
                ...
                <!-- Daily Forecast -->
                <router-link :to="{ name: 'daily', params: { city: weatherData.location.name } }" v-else-if="
                    weatherData &&
                    weatherData.forecast &&
                    weatherData.forecast.forecastday
                " class="flex gap-4">
