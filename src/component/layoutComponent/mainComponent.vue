...
<template>
  ...
  <div class="w-full max-w-6xl mx-auto">
    <!-- search box -->
    <div
      class="flex flex-col items-center md:flex-row justify-center gap-4 mb-5"
    >
      <searchComponent
      ...
      <div class="bg-white rounded-xl shadow col-span-2 p-5 mx-5 mb-5">
        ...
        <div class="flex">
          <div class="flex items-center">
            <button class="text-2xl font-bold cursor-default">
              Current Weather
            </button>
          </div>
          <div class="reload flex justify-end ml-auto items-center">
            <router-link
              v-if="weatherData && weatherData.location"
              :to="{
                name: 'toDay',
                params: { city: weatherData.location.name },
              }"
        ...
        <!-- current weather box -->
        <router-link
          v-if="weatherData?.location?.name"
