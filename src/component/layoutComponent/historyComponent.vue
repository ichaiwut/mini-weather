...
<template>
    <div class="">
        <!-- Header -->
        <div class="flex justify-between flex-col-3 mx-3 md:justify-around mb-3 lg:mx-auto max-w-3xl">
            <button @click="$router.back()" class="bg-blue-500 text-white px-4 py-2 rounded-xl mb-4 text-sm md:text-[17px] md:px-5">
                &larr; Back
            </button>
        ...
        <div class="flex justify-center flex-col items-center md:flex-row  mb-5 gap-3">
