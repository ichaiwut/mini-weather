  ...
  <div class="bg-zinc-800 text-white">
    <div class="container max-w-5xl mx-auto flex justify-between items-center py-4">
      <div class="text-2xl font-bold">
        AccuWeather <span class="text-base">Mueang Chiang Mai, Chiang Mai 32°c</span>
      </div>
      <div class="border border-gray-300 rounded-sm w-85 px-2 py-1 bg-white text-gray-900 flex items-center">
